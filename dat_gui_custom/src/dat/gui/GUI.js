...
function add(gui, object, property, params) {
  ...
  //checking for any errors in the object definition
  ...
  // determining the type of controller being used
  if (params.color) {
    ...
    controller = ControllerFactory.apply(gui, factoryArgs); // controller factory determines the type of controller
  }
